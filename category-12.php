         ...
         <div class="row py-3">
            ...
            <section class="col-xs-12 col-sm-7 col-md-8 col-lg-8 col-sm-push-5 col-md-push-4 col-lg-push-4">
              ...
              <?php if ( in_category('12')) { ?>
                <article class="row article-full">
...
<!--                         <p class="navigation justify-content-end">
                        ...
                        <p class="">
                          <?php previous_posts_link( '<i class="fas fa-arrow-circle-left"></i> Últimas noticias  ' ); ?>
						</p>
				        <p style="text-align:end;" >
                          <?php next_posts_link ( '  Más noticias <i class="fas fa-arrow-circle-right"></i>',''); ?>
                        </p>
